...
class TurtleBot2MazeEnv(turtlebot2_env.TurtleBot2Env):
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            #     reward = 1
            # elif distance_to_goal >= 120 and distance_to_goal < 160:
            #     reward = 2
            # elif distance_to_goal >= 80 and distance_to_goal < 120:
            #     reward = 3
            # elif distance_to_goal >= 40 and distance_to_goal < 80:
            #     reward = 4
            # elif distance_to_goal >= 20 and distance_to_goal < 40:
            #     reward = 5
