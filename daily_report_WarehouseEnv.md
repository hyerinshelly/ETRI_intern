...
- training result 확인 방법  
    ...
    - wrappers.Monitor에 video_callable=lambda episode_id: True를 추가하여 episode 녹화를 하려고 하였는데, NameError: name 'open' is not defined가 발생한다. log와 관련된 문제인데 해결 방법을 모르겠어서 포기하였다.
